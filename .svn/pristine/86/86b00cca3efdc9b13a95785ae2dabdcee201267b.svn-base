 ...
 */
@Service
public class TestBroadCastServicePost {
    ...
    public static void main(String[] args) throws Exception {
    	TestBroadCastServicePost t=new TestBroadCastServicePost();
    	t.init();
    	t.broadCast();
...
/*        defaultHeaders.add(new BasicHeader("Content-Type", "application/x-protobuf"));
        ...
        for (int i=0;i<cnt;i++) {
            try {
                ...
                String interface_url = TestBroadCastServicePost.URL;
                ...
                BasicHttpEntityEnclosingRequest request = new BasicHttpEntityEnclosingRequest("POST", interface_url);
