 ...
 * 分析TestSspLogReq.txt来源于ssp的日志,用于重现请求广告的场景，或分析请求没有广告的场景
 * @author dingyw
 *
 * 2017年3月22日
 */
public class TestSspReqByLogParser extends BaseTestSDKController{
	...
	public static void main(String[] args) {
		TestSspReqByLogParser t=new TestSspReqByLogParser();
		try {
			t.execute();
		} catch (Exception e) {
